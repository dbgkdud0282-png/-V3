      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8 pb-12 border-b border-white/5">
          ...
          <div className="md:col-span-4 space-y-3 text-xs">
            ...
            <div className="space-y-2 text-slate-300">
              <div className="flex items-center gap-2">
                ...
                <span>{config.overview.location} {config.overview.locationDetail}</span>
              </div>
              <div className="flex items-start gap-2">
                <MapPin className="w-4 h-4 text-amber-400 shrink-0 mt-0.5" />
                <span>분양사무실: 경기도 연천군 전곡역로 67, 1층 행복부동산</span>
              </div>
              <div className="flex items-center gap-2">
          ...
          <div className="md:col-span-3 space-y-3 text-xs">
            ...
            <ul className="space-y-2">
              <li>
                <a href="#parcels-section" className="hover:text-amber-400">
                  분양현황 (PARCELS)
                </a>
              </li>
              <li>
                <a href="#location-section" className="hover:text-amber-400">
                  입지환경 (한탄강 & 전곡역)
                </a>
              </li>
              <li>
                <a href="#special-value-section" className="hover:text-amber-400">
                  특장점 (SPECIAL VALUE)
                </a>
              </li>
              <li>
              ...
              <li>
                <a href="#reservation-section" className="hover:text-amber-400 text-amber-300 font-semibold">
                  현장방문 예약
                </a>
              </li>
            </ul>
        ...
        <div className="pt-8 flex flex-col sm:flex-row items-center justify-between gap-4 text-[11px] text-slate-500">
          <div>
            ...
            <span>사업자등록번호: {config.footer.businessNumber}</span>
            <span className="mx-2">|</span>
            <span>주소: {config.footer.address}</span>
            <p className="mt-1 text-slate-400 font-medium">분양사무실: 경기도 연천군 전곡역로 67, 1층 행복부동산</p>
            <p className="mt-1">{config.footer.copyright}</p>
          </div>
